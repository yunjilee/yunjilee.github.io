...
function() {
    ...
    function R(c) {
        if (c && M) {
            ...
            return t.head.insertBefore(l, v),
            c
        }
    }
    var W = 0;
    ...
    function vc(c) {
        ...
        L = r.startCentered,
        d = "",
        d += (u = void 0 !== L && L) && i ? "translate(" + (f.x / F - n / 2) + "em, " + (f.y / F - C / 2) + "em) " : u ? "translate(calc(-50% + " + f.x / F + "em), calc(-50% + " + f.y / F + "em)) " : "translate(" + f.x / F + "em, " + f.y / F + "em) ",
        d += "scale(" + f.size / F * (f.flipX ? -1 : 1) + ", " + f.size / F * (f.flipY ? -1 : 1) + ") ",
    ...
    var zc = function() {}
      ...
      , mc = function(c) {
        ec.mark(ac + " " + c + " ends"),
        ec.measure(ac + " " + c, ac + " " + c + " begins", ac + " " + c + " ends")
    }
      , tc = {
        begin: function(c) {
      ...
      , sc = function(c, l, h, v) {
        var z, e, a, m, t, s = Object.keys(c), r = s.length, f = void 0 !== v ? (m = l,
        t = v,
        function(c, l, h, v) {
    ...
    function uc(c) {
        ...
        return "string" == typeof c ? U(c) : "<" + h + " " + (l = z,
        Object.keys(l || {}).reduce(function(c, h) {
            return c + (h + '="') + U(l[h]) + '" '
    ...
    var Sc = function(c) {
        var l, h, v, z, e = c.getAttribute("data-prefix"), a = c.getAttribute("data-icon"), m = void 0 !== c.innerText ? c.innerText.trim() : "", t = Cc(X(c));
        return e && a && (t.prefix = e,
        t.iconName = a),
        t.prefix && m.length > 1 ? t.iconName = (v = t.prefix,
        z = c.innerText,
        ic[v][z]) : t.prefix && 1 === m.length && (t.iconName = (l = t.prefix,
        h = function(c) {
      ...
      , Oc = function(c) {
        ...
        return O.autoA11y && (h ? l["aria-labelledby"] = O.replacementClass + "-title-" + B() : l["aria-hidden"] = "true"),
        l
    }
      , jc = function(c) {
    ...
    function Xc(c) {
        var l, h, v, z, e, a, m, t, s, r, f, M, n, H, o, V, C, L, u, d = (h = Sc(l = c),
        v = h.iconName,
        z = h.prefix,
        e = h.rest,
        a = kc(l),
        ...
        return ~d.extra.classes.indexOf(Rc) ? function(c, l) {
            ...
            return O.autoA11y && !h && (z.attributes["aria-hidden"] = "true"),
            [c, vc({
                content: c.innerHTML,
                width: e,
                height: a,
    ...
    var vl, zl = new Qc, el = (vl = function(c) {
        ...
        if (c) {
            ...
            return ll(k({
                ...
                return cl(),
                O.autoA11y && (s ? i["aria-labelledby"] = O.replacementClass + "-title-" + B() : i["aria-hidden"] = "true"),
                hc({
                    icons: {
                        main: Zc(C),
                        mask: m ? Zc(m.icon) : {
    ...
    function(c) {
        ...
        f && (m.FontAwesome || (m.FontAwesome = al),
        T(function() {
            Object.keys(E.styles).length > 0 && ml(),
            O.observeMutations && "function" == typeof MutationObserver && function(c) {
                if (s) {
                    ...
                    wc = new s(function(c) {
                        yc || D(c).forEach(function(c) {
                            ...
                            l(c.target)),
                            "attributes" === c.type && c.target.parentNode && O.searchPseudoElements && v(c.target.parentNode),
                            "attributes" === c.type && pc(c.target) && ~b.indexOf(c.attributeName))
        ...
        E.hooks = k({}, E.hooks, {
            addPack: function(c, l) {
                E.styles[c] = k({}, E.styles[c] || {}, l),
                Hc(),
                ml()
            },
            addShims: function(c) {
                var l;
                (l = E.shims).push.apply(l, S(c)),
                Hc(),
                ml()
            }
        })
